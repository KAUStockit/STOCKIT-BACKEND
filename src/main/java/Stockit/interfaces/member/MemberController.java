...
public class MemberController {
    ...
    public CommonResponse<List<MemberInfo>> list() {
        return CommonResponse.success(memberService.findAllMembers());
    }
...
//        form.encodePassword(passwordEncoder.encode(form.getPassword()));
    ...
    public CommonResponse<List<RankingInfo>> getRankList() {
        return CommonResponse.success(memberService.getRankList());
    }
    ...
    public CommonResponse<List<OrderInfo>> getOrders(@PathVariable Long memberId) throws NotFoundException {
    ...
    public CommonResponse<Pair<List<AccountStockInfo>, List<StockInfo>>> getMyStocks(@PathVariable Long memberId) throws NotFoundException {
        final MemberInfo memberInfo = memberService.findMember(memberId);
